# derived from ryan4yin/nix-config, originally licensed under the MIT, modified by Jack77793
# ref: https://github.com/ryan4yin/nix-config/blob/be429dea2e17e286c45941a00aaa756f0d7793b1/hardening/bwraps/wechat.nix
#
